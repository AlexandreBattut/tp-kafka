 ...
 */
public final class WordsStream {
    ...
    static Properties getStreamsConfig(final String[] args) throws IOException {
        ...
        props.putIfAbsent(StreamsConfig.APPLICATION_ID_CONFIG, "line-to-word");
    ...
    static void createWordStream(final StreamsBuilder builder) {
        ...
        final KStream<String,String> words = source
            .flatMapValues(value -> Arrays.asList(pattern.split((value.toLowerCase(Locale.getDefault())),0)));
